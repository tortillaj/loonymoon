...
<?php else : ?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('mb-12'); ?>>
        ...
        <div class="entry-content">
            ...
            the_content(
                sprintf(
                    __('Continue reading %s', 'loonymoon'),
            ...
            wp_link_pages(
                array(
                    'before' => '<div class="page-links"><span class="page-links-title">' . __('Pages:', 'loonymoon') . '</span>',
                    'after' => '</div>',
                    'link_before' => '<span>',
                    'link_after' => '</span>',
                    'pagelink' => '<span class="screen-reader-text">' . __('Page', 'loonymoon') . ' </span>%',
